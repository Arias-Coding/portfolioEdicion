  ...
  return (
    <div id="Contactame" class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
      <div class="text-center">
        ...
        <a
          href="#"
          class="mt-8 inline-block rounded-full border border-indigo-600 border-2 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
        >
          Get Started
        </a>
      </div>
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl space-y-6">
          ...
          <p className="mx-auto max-w-lg text-xs text-gray-500 dark:text-gray-400">
            ...
            <span className="mt-4 block"> &copy; 2025 VideosEditor </span>
          </p>
        </div>
      </div>
    </footer>
