    ...
    >
      ...
      <div class="mt-16 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24">
        <div className="flex items-center gap-2">
          <a href="#Inicio" class="text-xs text-gray-400 hover:text-white">
            Inicio
          </a>
          <a href="#SobreMi" class="text-xs text-gray-400 hover:text-white">
            Sobre mi
          </a>
          <a
            href="#Especialidad"
          ...
          <a href="#Galeria" class="text-xs text-gray-400 hover:text-white">
            Galeria de Trabajos
          </a>
        </div>
