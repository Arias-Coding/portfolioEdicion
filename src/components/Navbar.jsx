export default function Navbar() {
  return (
    <nav class="backdrop-blur-lg py-2.5 top-0 p-4 z-40 fixed w-full">
      <div class="py-2 flex flex-row max-w-screen-xl px-4 mx-auto">
        ...
        <div class="basis-1/3 text-right lg:order-2">
          <a class="font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr- p-4 bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-purple-800">
            Contactame
          </a>
        </div>
      </div>
